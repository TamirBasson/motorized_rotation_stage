...
class SystemParametersPanel(ttk.Frame):
    """Editable system parameters: steps/rev, gear ratio, virtual zero offset."""

    def __init__(self, master: tk.Misc) -> None:
        super().__init__(master, padding=10, style="Panel.TFrame")
        self._steps_per_rev = tk.StringVar(value="200")
        self._gear_ratio = tk.StringVar(value="1")
    ...
    def _build(self) -> None:
        ...
        ttk.Entry(self, textvariable=self._gear_ratio, width=10).grid(row=2, column=1, sticky="ew", pady=2)
